...
import {
  ...
  stockStatusValues,
  transmissionTypes,
} from '../enums/vehicle-form-enums'
import { useBrands } from '@/features/panel/brands/hooks/use-brands'
import { useSuppliers } from '@/features/panel/suppliers/hooks/use-suppliers'
import { useVehicles } from '../hooks/use-vehicles'
import { cn } from '@/shared/lib/utils'
import { steps } from './data/vehicle-form-data'
import { defaultValues } from './data/vehicle-form-default-values'
import type { SupplierWithNameAndId } from '@/features/panel/suppliers/types/supplier-types'
import {
  IconCalendar,
  IconChevronLeft,
  IconChevronRight,
...
function AddVehicleForm() {
  const { getNamesAndIds } = useSuppliers()
  const suppliers: SupplierWithNameAndId[] = getNamesAndIds.data || []
  const { getNameAndIdBrand } = useBrands()
  const availableBrands = getNameAndIdBrand.data || []
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  ...
                  <EnumSelect
                    ...
                    labels={mappedTransmissionTypes}
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  ...
                  <EnumSelect
                    ...
                    onValueChange={field.onChange}
                    options={driveTrains}
                    labels={mappedDriveTrains}
                    placeholder="Seleccione tren de potencia"
                  />
                  <FieldDescription>
