...
import { IconArchive, IconLayout, IconPackage, IconShoppingCartCopy } from "@tabler/icons-react"
...
const filterOptions: FilterOption[] = [
  ...
  { value: "in_stock", label: "Disponibles", icon: <IconPackage className="size-4" /> },
  { value: "reserved", label: "Reservados", icon: <IconArchive className="size-4" /> },
  { value: "sold", label: "Vendidos", icon: <IconShoppingCartCopy className="size-4" /> },
]
